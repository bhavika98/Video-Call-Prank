package com.app.incroyable.videocall_prank.presentation.addcontact.components
...
fun AddContactBody(
    ...
    val emojiState = remember { mutableStateOf(defaultEmoji()[0]) }
                        ...
                        modifier = Modifier
                            ...
                            .clickable {
                                if (nameState.value.isEmpty() || contactState.value.isEmpty() || imageUri == null || videoUri == null) {
                                    ...
                                    context.toastMsg(context.getString(R.string.contact_added_successfully))
                                    context
                                        .findActivity()
                                        ?.finish()
                                }
