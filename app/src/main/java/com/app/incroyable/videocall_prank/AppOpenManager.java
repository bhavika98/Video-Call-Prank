...
import com.app.incroyable.videocall_prank.CustomApplication;import com.app.incroyable.videocall_prank.activity.AddContactActivity;
...
public class AppOpenManager implements LifecycleObserver, Application.ActivityLifecycleCallbacks {
    ...
    public void onStart() {
        if (currentActivity != null) {
            if (currentActivity instanceof CallScreenActivity
                    || currentActivity instanceof AddContactActivity
                    || currentActivity instanceof UpdateContactActivity) {
