...
public val DefaultCropperStyle: CropperStyle by lazy { CropperStyle(darkTheme = false) }
...
public fun CropperStyle(
    ...
    rectColor: Color = getTheme(darkTheme, customBottomIcon),
    ...
    overlay: Color = Color.Black.copy(alpha = .2f),
